...
export default async function CountsPage() {
      ...
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <p className="text-sm text-[var(--color-muted-foreground)] mb-6">
            Run physical counts area by area and know your sitting inventory value — upgrade to the Inventory add-on to
            unlock this page.
          </p>
          <Link
            href="/settings"
  ...
  return <CountsClient stores={stores.map((s) => ({ id: s.id, name: s.name }))} canManage={canManage} />
}
