    ...
    return (
      <div className="flex items-center justify-center min-h-[60vh]">
        <div className="text-center max-w-md">
          ...
          <h1 className="text-xl font-bold text-[var(--color-foreground)] mb-2">Inventory Reports</h1>
          <p className="text-sm text-[var(--color-muted-foreground)] mb-6">
            Sales, usage, cost % and COGS by category — powered by your counts, purchases, and Square sales. Upgrade to
            the Inventory add-on to unlock this page.
          </p>
          <Link
            href="/settings"
